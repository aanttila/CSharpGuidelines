...
### <a name="av1701"></a> Always use US-English (AV1701) ![](images/1.png)
...
### <a name="av1702"></a> Always use proper casing for language elements (AV1702) ![](images/1.png) 
...
### <a name="av1704"></a> Avoid numbers in variables, parameters, and type members (AV1704) ![](images/3.png)
In most cases they are a lazy excuse for not defining a clear and intention-revealing name.

### <a name="av1705"></a> Never prefix fields  (AV1705) ![](images/1.png)
...
### <a name="av1706"></a> Never use abbreviations  (AV1706) ![](images/2.png)
...
### <a name="av1707"></a> Always name members, parameters and variables according their meaning and not their type (AV1707) ![](images/2.png)
...
### <a name="av1708"></a> Always name types using nouns, noun phrases, or adjective phrases (AV1708) ![](images/2.png)
...
### <a name="av1709"></a> Always name generic type parameters with descriptive names (AV1709) ![](images/2.png)
...
### <a name="av1710"></a> Never repeat the name of a class or enumeration in its members (AV1710) ![](images/1.png)
...
### <a name="av1711"></a> Prefer naming members similarly to members of related .NET Framework classes (AV1711) ![](images/3.png)
...
### <a name="av1715"></a> Always name properties properly (AV1715) ![](images/2.png)
...
### <a name="av1720"></a> Always name methods using a verb or a verb-object pair (AV1720) ![](images/2.png)
...
### <a name="av1725"></a> Always name namespaces using names, layers, verbs, and features (AV1725) ![](images/3.png)
For instance, the following namespaces are good examples:
...
### <a name="av1735"></a> Always use a verb or verb phrase to name an event (AV1735) ![](images/2.png)
...
### <a name="av1738"></a> Always prefix an event handler with `On` (AV1738) ![](images/3.png)
...
### <a name="av1739"></a> Always use an underscore for irrelevant lambda parameters (AV1739) ![](images/3.png)
...
### <a name="av1755"></a> Always add the `Async` suffix to asynchronous methods (AV1755) ![](images/2.png)
The general convention for methods that return `Task` or `Task<TResult>` is to suffix them with `Async`.
