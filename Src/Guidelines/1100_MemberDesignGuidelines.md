...
### <a name="av1100"></a> Always allow properties to be set in any order (AV1100) ![](images/1.png)
...
### <a name="av1105"></a> Always use a method instead of a property... (AV1105) ![](images/3.png)
...
### <a name="av1110"></a> Never use mutually exclusive properties (AV1110) ![](images/1.png)
...
### <a name="av1115"></a> Prefer methods and properties that only do one thing (AV1115) ![](images/1.png)

Similarly to rule AV1000, a method should have a single responsibility.

### <a name="av1125"></a> Never expose stateful objects through static members (AV1125) ![](images/2.png)
...
### <a name="av1130"></a> Always expose `IEnumerable<T>` or `ICollection<T>` instead of a concrete collection class (AV1130) ![](images/2.png)
...
### <a name="av1135"></a> Never use `null` for properties, methods, or arguments representing collections (AV1135) ![](images/1.png)
...
### <a name="av1137"></a> Always define parameters as specific as possible (AV1137) ![](images/2.png)
