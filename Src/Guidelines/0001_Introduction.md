...
This document attempts to provide useful and pragmatic guidelines (or coding standards if you like) for coding in C#. Notice that not all guidelines have a clear rationale. Some of them are simply choices we made. In the end, it doesn't matter what choice you made, as long as you make one and apply it consistently.
...
This document is based on the [CSharpGuidelines project on GitHub](https://github.com/dennisdoomen/csharpguidelines).
...
Something isn't okay just because it is not mentioned in this document.

In general, this document is a set of basic principles that apply to most (if not all) situations, regardless of context. These include:
...
Regardless of the elegance of someone's solution, if it's too complex for the ordinary developer, exposes unusual behavior, or tries to solve many possible future issues, it is very likely the wrong solution and needs redesign. The worst response a developer can give you to these principles is: "it works". 
...
This document has been compiled using many contributions from community members, blog posts, on-line discussions and many years of developing in C#. If you have questions, comments or suggestions, just let me know by [creating an issue](https://github.com/aanttila/csharpguidelines/issues) or Pull Request. This document will be revised and republished with new insights, experiences and remarks on a regular basis.
